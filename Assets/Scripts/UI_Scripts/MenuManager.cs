...
//		Debug.Log("cliam"+PlayerPrefs.GetInt("claimvalue"));
		...
		if (UnityEngine.iOS.Device.generation == UnityEngine.iOS.DeviceGeneration.iPad1Gen ||
			...
			this.transform.Find("MainScreenPanel").Find("Man").GetComponent<RectTransform>().localScale = new Vector3(13, 6f, 6.548484f);

			Debug.Log("____iPad_______");

		
		} else {
			this.transform.Find("MainScreenPanel").Find("Man").GetComponent<RectTransform>().localScale = new Vector3(16, 6.145341f, 6.548484f);
